...
<div style={styles.tableSection}>
  ...
  <div style={styles.tableHeader}>
    ...
    <div style={styles.colStock}>Stock</div>
  ...
  <div style={styles.cart}>
    {cart.map(item => (
      <div key={item.id} style={styles.row}>
        ...
        <div style={styles.colStock}>{item.stock ?? 0}</div>
        ...
        <div style={styles.colPercent}>
          <input
            ...
            onChange={(e) =>
              updateItemDiscount(item.id, "itemDiscountPercent", e.target.value)
            }
            style={styles.cellInput}
          />
        </div>
        ...
        <div style={styles.colDisc}>
          <input
            type="number"
            value={item.itemDiscountFixed}
            onChange={(e) =>
              updateItemDiscount(item.id, "itemDiscountFixed", e.target.value)
            }
            style={styles.cellInput}
          />
        </div>
